        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Créer un Avancement - {{ $etablissement->nom_efp }}</h3>
                    <a href="{{ route('administration.etablissement.avancements.index') }}" class="btn btn-default float-right">
                        <i class="fas fa-arrow-left"></i> Retour
                    </a>
                </div>
                <form action="{{ route('administration.etablissement.avancements.store') }}" method="POST">
                    @csrf
                    <div class="card-body">
                        <div class="form-group">
                            <label for="affectation_id">Affectation *</label>
                            <select name="affectation_id" id="affectation_id" class="form-control @error('affectation_id') is-invalid @enderror" required>
                                ...
                                @foreach($affectations as $affectation)
                                    <option value="{{ $affectation->id }}" {{ old('affectation_id') == $affectation->id ? 'selected' : '' }}>
                                        ...
                                        Module: {{ $affectation->module->nom_module }} | 
                                        Formateur Présentiel: {{ $affectation->formateurPresentiel->nom_complet ?? 'N/A' }}
                                    </option>
                                @endforeach
                            </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" name="mh_realisee_presentiel" id="mh_realisee_presentiel" 
                                           ...
                                           value="{{ old('mh_realisee_presentiel') }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" name="mh_realisee_sync" id="mh_realisee_sync" 
                                           ...
                                           value="{{ old('mh_realisee_sync') }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" name="mh_realisee_globale" id="mh_realisee_globale" 
                                           ...
                                           value="{{ old('mh_realisee_globale') }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" name="taux_realisation_presentiel" id="taux_realisation_presentiel" 
                                           ...
                                           value="{{ old('taux_realisation_presentiel') }}" min="0" max="100" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" name="taux_realisation_syn" id="taux_realisation_syn" 
                                           ...
                                           value="{{ old('taux_realisation_syn') }}" min="0" max="100" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" name="taux_realisation_globale" id="taux_realisation_globale" 
                                           ...
                                           value="{{ old('taux_realisation_globale') }}" min="0" max="100" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" name="moyenne_absence" id="moyenne_absence" 
                                           ...
                                           value="{{ old('moyenne_absence') }}" min="0" max="100" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="nb_cc" id="nb_cc" 
                                           ...
                                           value="{{ old('nb_cc') }}" min="0" required>
                                    @error('nb_cc')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="seance_efm" id="seance_efm" class="form-control @error('seance_efm') is-invalid @enderror" required>
                                        <option value="Oui" {{ old('seance_efm') == 'Oui' ? 'selected' : '' }}>Oui</option>
                                        <option value="Non" {{ old('seance_efm') == 'Non' ? 'selected' : '' }}>Non</option>
                                    </select>
                                    @error('seance_efm')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="validation_efm" id="validation_efm" class="form-control @error('validation_efm') is-invalid @enderror" required>
                                        <option value="oui" {{ old('validation_efm') == 'oui' ? 'selected' : '' }}>Oui</option>
                                        <option value="non" {{ old('validation_efm') == 'non' ? 'selected' : '' }}>Non</option>
                                    </select>
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save"></i> Créer l'Avancement
                        </button>
