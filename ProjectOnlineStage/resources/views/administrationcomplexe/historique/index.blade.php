...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <h2><i class="fas fa-history"></i> Historique des Avancements (Complexe)</h2>
                <a href="{{ route('administration.complexe.dashboard') }}" class="btn btn-secondary">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('administration.complexe.historique.index') }}" id="filterForm">
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <select name="etablissement" id="etablissement" class="form-select">
                            ...
                            @foreach($etablissements as $etab)
                                <option value="{{ $etab->code_efp }}" 
                                    {{ $codeEfpFiltre == $etab->code_efp ? 'selected' : '' }}>
                                    {{ $etab->nom }} ({{ $etab->code_efp }})
                                </option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <a href="{{ route('administration.complexe.historique.export', request()->all()) }}" 
                    ...
                    <table class="table table-bordered table-hover table-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><small class="text-muted">{{ $h->code_efp }}</small></td>
                                <td>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('administration.complexe.historique.show', $h->id) }}" 
...
<div class="modal fade" id="compareModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form method="GET" action="{{ route('administration.complexe.historique.compare') }}" id="compareForm">
                <div class="modal-body">
                    <!-- Section Établissement -->
                    <div class="row mb-4">
                        <div class="col-12">
                            <h6 class="text-primary"><i class="fas fa-building"></i> Sélection de l'établissement</h6>
                            <hr>
                        </div>
                        <div class="col-md-12 mb-3">
                            <label for="compare_etablissement" class="form-label">Établissement <span class="text-danger">*</span></label>
                            <select name="etablissement" id="compare_etablissement" class="form-select">
                                <option value="">Tous les établissements</option>
                                @foreach($etablissements as $etab)
                                    <option value="{{ $etab->code_efp }}">
                                        {{ $etab->nom }} ({{ $etab->code_efp }})
                    ...
                    <div class="alert alert-info mb-0">
                        ...
                        <strong>Astuce:</strong> Utilisez les filtres pour analyser l'évolution d'un établissement, formateur, 
...
<script>
    ...
    // Auto-remplissage si déjà filtré
    @if(request('etablissement'))
        document.getElementById('compare_etablissement').value = '{{ request('etablissement') }}';
    @endif
