...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-md-8">
            <h1 class="h3 d-inline-block fw-bold">Modifier le Secteur</h1>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card shadow-sm">
                <div class="card-body">
                    <form action="{{ route('administration.etablissement.secteurs.update', $secteur->id) }}" method="POST" novalidate>
                        @csrf
                        @method('PUT')
        ...
        <div class="col-md-4">
            <div class="card shadow-sm bg-light">
                <div class="card-body">
                    ...
                    <ul class="small">
                        <li><strong>ID:</strong> {{ $secteur->id }}</li>
                        <li><strong>Créé le:</strong> {{ $secteur->created_at->format('d/m/Y H:i') }}</li>
                        <li><strong>Modifié le:</strong> {{ $secteur->updated_at->format('d/m/Y H:i') }}</li>
                    </ul>
                </div>
            </div>
        </div>
