        ...
        <div class="col-lg-8">
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('administration.etablissement.formations.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-select @error('type_formation') is-invalid @enderror" 
                                        ...
                                        <option value="Initiale" {{ old('type_formation') == 'Initiale' ? 'selected' : '' }}>
                                            Initiale
                                        </option>
                                        <option value="Continue" {{ old('type_formation') == 'Continue' ? 'selected' : '' }}>
                                            Continue
                                        </option>
                                        <option value="Alternance" {{ old('type_formation') == 'Alternance' ? 'selected' : '' }}>
                                            Alternance
                                        </option>
                                        <option value="Apprentissage" {{ old('type_formation') == 'Apprentissage' ? 'selected' : '' }}>
                                            Apprentissage
                                        </option>
                                        <option value="Diplômante" {{ old('type_formation') == 'Diplômante' ? 'selected' : '' }}>
                                            Diplômante
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-select @error('creneau') is-invalid @enderror" 
                                        ...
                                        <option value="Matin" {{ old('creneau') == 'Matin' ? 'selected' : '' }}>
                                            Matin
                                        </option>
                                        <option value="Après-midi" {{ old('creneau') == 'Après-midi' ? 'selected' : '' }}>
                                            Après-midi
                                        </option>
                                        <option value="Soir" {{ old('creneau') == 'Soir' ? 'selected' : '' }}>
                                            Soir
                                        </option>
                                        <option value="Journée complète" {{ old('creneau') == 'Journée complète' ? 'selected' : '' }}>
                                            Journée complète
                                        </option>
                                        <option value="CDJ" {{ old('creneau') == 'CDJ' ? 'selected' : '' }}>
                                            CDJ
                                        </option>
                                    </select>
                                </div>
                        ...
                        <div class="alert alert-info mb-4">
                            ...
                            L'établissement sera automatiquement associé à cette formation.
