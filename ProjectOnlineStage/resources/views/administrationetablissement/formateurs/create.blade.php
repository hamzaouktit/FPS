    ...
    <div class="row mb-4">
        <div class="col-md-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="mb-1">Créer un Formateur</h2>
        ...
        <div class="col-md-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    <form action="{{ route('administration.etablissement.formateurs.store') }}" method="POST" id="formateurForm">
                        @csrf
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('type') is-invalid @enderror" 
                                            ...
                                            <option value="permanent" {{ old('type') == 'permanent' ? 'selected' : '' }}>
                                                <i class="fas fa-user-tie"></i> Permanent
                                            </option>
                                            <option value="vacataire" {{ old('type') == 'vacataire' ? 'selected' : '' }}>
                                                <i class="fas fa-user-clock"></i> Vacataire
                                            </option>
                                        </select>
                                        @error('type')
                                            <div class="invalid-feedback">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <small class="form-text text-muted">Par défaut: 910 heures</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      name="description" 
                                      rows="3" 
                                      placeholder="Entrez une description pour le formateur...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">
                                    <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                </div>
                            @enderror
                            <small class="form-text text-muted">Fournissez des informations supplémentaires sur le formateur (optionnel)</small>
                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label for="secteurs" class="form-label">
                                            ...
                                            <span class="badge bg-info-subtle text-info ms-2" id="secteurCount">0 sélectionné(s)</span>
                                        </label>
                                        <select multiple 
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label for="modules" class="form-label">
                                            ...
                                            <span class="badge bg-secondary-subtle text-secondary ms-2" id="moduleCount">0 sélectionné(s)</span>
                                        </label>
                                        <select multiple 
                        ...
                        <div class="form-actions d-flex justify-content-between align-items-center">
                            ...
                            <div class="btn-group">
                                ...
                                <button type="submit" class="btn btn-success">
                                    <i class="fas fa-save me-2"></i> Créer le Formateur
                                </button>
                            </div>
                        </div>
                    </form>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (secteursSelect && secteurCount) {
        ...
        const initialSecteursCount = Array.from(secteursSelect.selectedOptions).length;
        secteurCount.textContent = initialSecteursCount + ' sélectionné(s)';
    }
    ...
    if (modulesSelect && moduleCount) {
        ...
        // Initialiser le compte au chargement
        const initialModulesCount = Array.from(modulesSelect.selectedOptions).length;
        moduleCount.textContent = initialModulesCount + ' sélectionné(s)';
    }
