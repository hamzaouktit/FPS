                ...
                <div class="card-body">
                    <form action="{{ route('administration.etablissement.niveaux.store') }}" method="POST">
                        ...
                        <div class="alert alert-info" role="alert">
                            ...
                            <strong>Important :</strong> Une fois créé, ce niveau sera disponible pour vos formations. Il apparaîtra dans les filtres du dashboard dès qu'une formation l'utilisera.
                        </div>
